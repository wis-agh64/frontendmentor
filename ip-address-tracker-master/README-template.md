...
This was a fun review on mapping and using APIs. I also took the opportunity to set up a proxy on Cloudflare to protect the API key (even if not necessary for the purposes of this project).
